        ...
        <StyledHeroSection ref={heroSection} id="hero">
            <HeroSectionLeft>
                <HeroContent>
                    ...
                    <Heading as="h1">
                        Administrare Imobile in grija noastra
                    </Heading>
                    <HeroDescription>
                        Servicii complete de administrare imobile. Totul mai
                        facil si accesibil proprietarilor.
                    </HeroDescription>
                    <HeroAction>
                        ...
                        <FormTrigger>
                            <ButtonTrigger $variation="primary">
                                Contact
                            </ButtonTrigger>
                        </FormTrigger>
                    </HeroAction>
            ...
            <HeroSectionRight>
                <HeroMainImgBox>
                    <HeroImg src={heroMain} alt="Imagine Imobiliare"></HeroImg>
                </HeroMainImgBox>
                <HeroContactLinks>
                    <li>
                        <a>
